// $Id: runH4lZPlusFakeSkim.C,v 1.1 2012/06/02 20:46:24 paus Exp $
...
//--------------------------------------------------------------------------------------------------
void runH4lZPlusFakeSkim(const char *fileset    = "0000",
			 const char *skim       = "noskim",
			 const char *dataset    = "r11b-pho-pr-v1",
			 const char *book       = "local/filefi/025",
			 const char *catalogDir = "/home/cmsprod/catalog",
			 const char *outputName = "z_plus_fake",
			 int         nEvents    = 1000)
{
  //------------------------------------------------------------------------------------------------
  ...
  // the skimmer
  //------------------------------------------------------------------------------------------------
  H4lZPlusFakeSkim *skmMod = new H4lZPlusFakeSkim();
